...
execute if entity @e[tag=ija-a4-lang-nl,scores={ija-a4-counter=49}] run tellraw @a [{"text":"\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n Je hebt fase 1 bereikt: De Vlaktes!","color":"gold"},{"text":"\n Hier groeien genoeg bloemen en bomen voor een heel leven.","color":"yellow"},{"text":"\n  ➡ Klik om de instellingen te openen.","italic":true,"color":"gray","clickEvent":{"action":"run_command","value":"/trigger ija-a4-trigger set 1"},"hoverEvent":{"action":"show_text","value":"Open de instellingen."}}]
execute if entity @e[tag=ija-a4-lang-sk,scores={ija-a4-counter=49}] run tellraw @a [{"text":"\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n Dosiahol si fázu 1: Plains!","color":"gold"},{"text":"\n Dosť kvetov a stromov tu rastie aby vystačili na celý život.","color":"yellow"},{"text":"\n  ➡ Klini aby si otvoril nastavenia.","italic":true,"color":"gray","clickEvent":{"action":"run_command","value":"/trigger ija-a4-trigger set 1"},"hoverEvent":{"action":"show_text","value":"Otvor\nmenu nastavení."}}]
